...
import org.siri.swing.util.events.*;

public class FatViewToolbar
    implements ApplicationStateEventListener
{
    ...
    Border border1;
    private static FatViewToolbar myInstance;
    JToolBar myJToolBar = new JToolBar();
    JButton jButtonReconnect = new JButton();

    public static FatViewToolbar getInstance()
    {
        if (myInstance == null)
        {
            myInstance = new FatViewToolbar();
        }
        return myInstance;
    }
