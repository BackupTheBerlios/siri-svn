package org.siri.swing.util.tooltip;
    ...
    extends BasicToolTipUI
{
    ...
    public Dimension getPreferredSize(JComponent c)
    {
        ...
        return new Dimension(width + BLANK_SPACE * 2, height + BLANK_SPACE * 2);
    }
    ...
    public void paint(Graphics g, JComponent c)
    {
        ...
        if (extendedWidth)
        {
            ...
            PANE.paintComponent(g, TEXT, c, BLANK_SPACE, BLANK_SPACE, dimension.width - BLANK_SPACE * 2,
                dimension.height - BLANK_SPACE * 2, true);
            return;
        }
        ...
        for (i = 0, height = BLANK_SPACE + fontAscent; i < num_lines; i++, height += fontHeight)
        {
