...
public class PopTypeImpl implements org.iris.xml.server.settings.PopType, com.sun.xml.bind.JAXBObject, org.iris.xml.server.settings.impl.runtime.UnmarshallableObject, org.iris.xml.server.settings.impl.runtime.XMLSerializable, org.iris.xml.server.settings.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Popserver;
    public final static java.lang.Class version = (org.iris.xml.server.settings.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.iris.xml.server.settings.PopType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPopserver() {
        if (_Popserver == null) {
            _Popserver = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Popserver;
    }

    public java.util.List getPopserver() {
        return _getPopserver();
    }
    ...
    public org.iris.xml.server.settings.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.iris.xml.server.settings.impl.runtime.UnmarshallingContext context) {
        return new org.iris.xml.server.settings.impl.PopTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Popserver == null)? 0 :_Popserver.size());
        while (idx1 != len1) {
            context.startElement("", "popserver");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Popserver.get(idx_0 ++)), "Popserver");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Popserver.get(idx_1 ++)), "Popserver");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Popserver.get(idx1 ++)), "Popserver");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000*org.iris.xml.server.settings.PopserverTypet\u0000+http://jav"
...
+"~\u0000\u001dsq\u0000~\u0000\u001et\u0000\tpopservert\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.Express"
...
+"m/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000\u0013q\u0000~\u0000"
+"\u0010q\u0000~\u0000#q\u0000~\u0000\u0005x"));
        }
        ...
        extends org.iris.xml.server.settings.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.iris.xml.server.settings.impl.PopTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _getPopserver().add(((org.iris.xml.server.settings.impl.PopserverTypeImpl) spawnChildFromEnterAttribute((org.iris.xml.server.settings.impl.PopserverTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
