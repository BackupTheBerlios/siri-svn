...
public class SystemConfigImpl
    extends org.iris.xml.server.settings.impl.SystemConfigTypeImpl
    implements org.iris.xml.server.settings.SystemConfig, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.iris.xml.server.settings.impl.runtime.UnmarshallableObject, org.iris.xml.server.settings.impl.runtime.XMLSerializable, org.iris.xml.server.settings.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.iris.xml.server.settings.SystemConfig.class);
    }
    ...
    public org.iris.xml.server.settings.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.iris.xml.server.settings.impl.runtime.UnmarshallingContext context) {
        return new org.iris.xml.server.settings.impl.SystemConfigImpl.Unmarshaller(context);
    }

    public void serializeBody(org.iris.xml.server.settings.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "system-config");
...
+"q\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000/org.iris.xml.server.settings.GlobalSettingsTyp"
...
+"ema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000fglobal-settingst\u0000\u0000sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u0000pp"
+"\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~\u0000\u001d"
+"q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000(org.iris.xml.server.settings.ServiceTypeq\u0000~\u0000$s"
+"q\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0007serviceq\u0000~\u0000?sq\u0000~\u0000"
...
+"~\u00008q\u0000~\u0000Qq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0004nameq\u0000~\u0000?sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000"
+":q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\rsystem-configq\u0000~\u0000?sr\u0000\"com.sun.msv.grammar.Exp"
...
+"q\u0000~\u0000Dq\u0000~\u0000\u0013q\u0000~\u0000Eq\u0000~\u0000\u000bq\u0000~\u0000\nq\u0000~\u0000\rq\u0000~\u0000Bq\u0000~\u0000%q\u0000~\u0000Iq\u0000~\u0000Wx"));
        ...
        extends org.iris.xml.server.settings.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.iris.xml.server.settings.impl.SystemConfigImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        break;
                    case  0 :
                        if (("system-config" == ___local)&&("" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((org.iris.xml.server.settings.impl.SystemConfigTypeImpl)org.iris.xml.server.settings.impl.SystemConfigImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                }
