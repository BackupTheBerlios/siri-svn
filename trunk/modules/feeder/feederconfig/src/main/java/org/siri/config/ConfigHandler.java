...
public class ConfigHandler
{
    ...
    private static String filePath = "C:\\gepo\\siri\\modules\\feeder\\feederconfig\\src\\test-data\\feederconfig.xml";
    ...
    {
        ConfigHandler thisSample = new ConfigHandler();
...
//        System.out.println(systemConfigDocument.getSystemConfig().getName() );
  ...
  /*  public boolean isValidOnTheFly(String xmlPath)
    {
        ...
        TodolistDocument todoList = (TodolistDocument)parseXml(xmlPath, validationOptions);
