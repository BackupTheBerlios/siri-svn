 ...
 */
public class ServiceSummaryItemCellRenderer
    extends JLabel implements ListCellRenderer
{
     ...
     */
    public ServiceSummaryItemCellRenderer()
    {
        setOpaque(true);
    }
        ...
        boolean cellHasFocus)
    {
        ...
        setText( ( (ServiceSummaryItem) value).toString());
        setIcon( ( (ServiceSummaryItem) value).getIcon());
