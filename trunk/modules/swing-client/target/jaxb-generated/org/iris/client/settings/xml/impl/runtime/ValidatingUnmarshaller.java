...
import org.iso_relax.verifier.impl.*;
import org.xml.sax.*;
...
public class ValidatingUnmarshaller
    extends ForkContentHandler implements SAXUnmarshallerHandler
{
    ...
    public void startElement(String nsUri, String local, String qname, Attributes atts) throws SAXException
    {
        ...
        for (int i = 0; i < len; i++)
        {
            ...
            if (aUri.equals("http://www.w3.org/2001/XMLSchema-instance") && (aLocal.equals("schemaLocation") ||
