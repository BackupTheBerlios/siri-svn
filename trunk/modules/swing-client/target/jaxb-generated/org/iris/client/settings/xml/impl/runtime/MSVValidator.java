    ...
    implements XMLSerializer, IDContextProvider2
{
    ...
    public void endAttributes() throws SAXException
    {
        if (!acceptor.onEndAttributes(null, null))
        {
            ...
            // causes this error.
            StringRef ref = new StringRef();
            StartTagInfo sti = new StartTagInfo(currentElementUri, currentElementLocalName, currentElementLocalName,
    ...
    public void endAttribute() throws SAXException
    {
        ...
        if (!acceptor.onAttribute2(attNamespaceUri, attLocalName, attLocalName
            /* we don't have QName, so just use the local name */, buf.toString(), this, null, null))
        {
...
//            atts = emptyAttributes;
        ...
        StartTagInfo sti = new StartTagInfo(DUMMY_ELEMENT_NS, intfName, intfName
                           /*just pass the local name as QName.*/, emptyAttributes, this);
