    ...
    implements XMLSerializer
{
    ...
    public String onIDREF(IdentifiableObject obj) throws SAXException
    {
        ...
        if (id == null)
        {
            reportError(new NotIdentifiableEventImpl(ValidationEvent.ERROR,
                Messages.format(Messages.ERR_NOT_IDENTIFIABLE), new ValidationEventLocatorImpl(obj)));
        }
        return id;
    }
    ...
    void reconcileID() throws AbortSerializationException
    {
        ...
        for (Iterator itr = idReferencedObjects.iterator(); itr.hasNext(); )
        {
            ...
            reportError(new NotIdentifiableEventImpl(ValidationEvent.ERROR, Messages.format(Messages.ERR_DANGLING_IDREF,
                o.____jaxb____getId()), new ValidationEventLocatorImpl(o)));
        }
